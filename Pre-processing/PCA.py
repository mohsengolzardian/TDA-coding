...
# Load the LAS file
las = laspy.read("C:/Users/golzardm/Documents/paper-TDA-embankment-monitoring/Pre-processing/abnormality_hump_4.las")
...
# Threshold factor
threshold_factor = 2.5 # Adjust this to control outlier strictness
