...
class SurfaceWithSmoothCircularCavity:
    ...
    def save_mesh(self, filename="surface_with_smooth_circular_cavity_15.obj"):
...
if __name__ == "__main__":
    ...
    params = {
        ...
        'cavity_radius': 15, # radius of the cavity
