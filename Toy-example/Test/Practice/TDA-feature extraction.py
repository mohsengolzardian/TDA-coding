...
class tda:
    ...
    def random_sampling_consensus(self, pcd, m=500, K=10):
        ...
        for i in range(K):
            ...
            if pcd.shape[0] > m:
                ...
                subset = pcd
            #  persistence diagram on the subset
        ...
        # saving the median consensus features to a CSV file.
    ...
    def forward(self, pcd_list):
        ...
        Computes persistence diagrams on the given dataset and extracts TDA features.
        """
    ...
    def save_homology_dimensions(self, diagram_index=0, filename_prefix="point_cloud"):
        """
        Saving the H0 and H1 persistence diagram data as CSV files.
        """
...
########
# Main code: extract TDA features 
...
# visualizing the randomly sampled subset.
