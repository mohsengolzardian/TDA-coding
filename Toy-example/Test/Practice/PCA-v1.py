...
cavity_threshold = np.percentile(pc_values[:, 2], 10)    # extract the third PC (pc3) with 10% of pc3 from bottom 
cavity_points = xyz[pc_values[:, 2] < cavity_threshold]  # only the points belong to the cavity extracted
