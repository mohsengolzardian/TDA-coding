...
normalized_features = (median_features_array - median_features_array.min(axis=0)) / (median_features_array.max(axis=0) - median_features_array.min(axis=0))
...
# Visualize the randomly sampled subset.
