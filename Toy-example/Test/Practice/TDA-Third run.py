...
from gtda.plotting import plot_diagram  # Import the plotting function
import numpy as np
...
class tda:
    def __init__(self, homo_dim=1, fts='entropy') -> None:
        ...
        self.persistence = VietorisRipsPersistence(
            ...
            #max_edge_length=50,  # limit scale for faster computation
            n_jobs=-1)
        self.fts = fts
        if fts == 'entropy':
    ...
    def forward(self, pcd):
        ...
        # Plot the persistence diagram for the first point cloud (optional)
...
my_tda = tda(homo_dim=1, fts='entropy')
